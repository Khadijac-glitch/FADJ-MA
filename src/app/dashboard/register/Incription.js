...
<div className="mb-4 relative right-20">
 ...
 <button
      ...
      <div className="flex items-center space-x-6 my-4"> {/* Checkbox group */}
...
{/* Date inputs */}
      ...
      <div className="grid grid-cols-3 gap-0 mb-4"> 
        ...
        <div className='relative right-20'>
          <label htmlFor="floatingSelectGrid" className="block text-sm font-medium text-gray-50">
          Date de naissance 
          </label>
          <select
            id="floatingSelectGrid"
...
<div className="mb-4 relative right-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4"> {/* Additional email input */}
        <div className="mb-4 ">
          <label htmlFor="floatingInputGrid" className="block text-sm font-medium text-gray-700">
           {/* S'inscrire */}
          </label>
